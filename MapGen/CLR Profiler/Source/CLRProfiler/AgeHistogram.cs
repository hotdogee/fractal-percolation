...
namespace CLRProfiler
{
    ...
    public class AgeHistogram : System.Windows.Forms.Form
    {
        ...
        private uint BuildBuckets(double timeScale, double maxAge)
        {
        ...
        uint GetScale(GroupBox groupBox, int pixelsAvailable, uint rangeNeeded)
        {
        ...
        uint GetVerticalScale(int pixelsAvailable, uint rangeNeeded)
        {
        ...
        private uint Init(Graphics g)
        {
            ...
            uint maxBucketSize = BuildBuckets(timeScale, maxAge);
