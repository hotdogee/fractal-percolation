...
namespace CLRProfiler
{
    ...
    public class HistogramViewForm : System.Windows.Forms.Form
    {
        ...
        private void DrawTypeLegend(Graphics g)
        {
            ...
            string s = string.Format("Grand total: {0:n0} bytes - {1:n0} instances, {2:n0} bytes average size", totalSize, totalCount, totalSize/totalCount);
            ...
            foreach (TypeDesc t in sortedTypeTable)
            {
                ...
                s = string.Format(" ({0:n0} bytes, {1:f2}% - {2:n0} instances, {3:n0} bytes average size)", t.totalSize, (double)t.totalSize/totalSize*100.0, t.count, t.totalSize/t.count);
